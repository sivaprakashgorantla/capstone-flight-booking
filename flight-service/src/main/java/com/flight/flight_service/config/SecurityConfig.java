...
import com.flight.flight_service.filter.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/flights/health").permitAll()
                // Swagger / OpenAPI
                .requestMatchers(
                    "/v3/api-docs/**",
                    "/swagger-ui/**",
            ...
            .headers(headers -> headers.frameOptions(fo -> fo.disable())) // H2 console iframe
